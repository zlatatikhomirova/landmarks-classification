...
Проверка алгоритмов приведена в ноутбуке **example.ipynb**. Примеры хороших и плохих изображений приведены в папке **ex_images**. Метрика фильтрации - % отброшенных плохих.
